...
<html lang="en">
  ...
  <body>
  	<form action="<c:url value="/log/money" />" method="get">
  	<div class="row">
		<div class="col-sm-3">
	...
	<ul class="pager">
		...
		<c:if test="${page > 1 }">
			<li><a
				href="money?date=${date }&userId=${userId }&page=${page-1}">Previous</a>
			</li>
		</c:if>
		<li><a href="money?date=${date }&userId=${userId }&page=${page+1}">Next</a>
		</li>
	</ul>
