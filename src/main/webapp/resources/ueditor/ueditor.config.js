...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [["source","insertunorderedlist","insertorderedlist","preview","help","|","emotion","date","time","horizontal","anchor","spechars","blockquote","template","bold","italic","underline","forecolor","backcolor","superscript","subscript","justifyleft","justifycenter","justifyright","justifyjustify","indent","removeformat","formatmatch","autotypeset","customstyle","rowspacingbottom","rowspacingtop","lineheight","fontfamily","fontsize","inserttable","deletetable","mergeright","mergedown","splittorows","splittocols","splittocells","mergecells","insertcol","insertrow","deletecol","deleterow","insertparagraphbeforetable"]]
